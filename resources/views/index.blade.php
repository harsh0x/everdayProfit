        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('signup')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Sign up</a>
                    <a href="{{route('index')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{route('index')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{route('index')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="ri-money-dollar-box-fill fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Level ROI Income</p>
                                <h6 class="mb-0">$1234</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="ri-rocket-line fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Booster Income</p>
                                <h6 class="mb-0">$1234</h6>
                            </div>
                        </div>
                    </div>
